...
def main():
    ...
    # 恢复cyrg2025数据库
    print("\n2️⃣ 恢复cyrg2025数据库...")
    success1 = restore_database_step_by_step(conn, "cyrg2025", "/backup/cyrg_backup_2025_09_09_000004_9004235.bak")
    
    # 恢复cyrgweixin数据库
    print("\n3️⃣ 恢复cyrgweixin数据库...")
    success2 = restore_database_step_by_step(conn, "cyrgweixin", "/backup/zhkj_backup_2025_09_09_000002_6761311.bak")
