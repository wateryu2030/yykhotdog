...
import salesComparisonRoutes from './routes/salesComparison';
...
import enhancedAIAnalysisRoutes from './routes/enhancedAIAnalysis';
...
app.use('/api/sales-comparison', salesComparisonRoutes);
...
app.use('/api/enhanced-ai-analysis', enhancedAIAnalysisRoutes);
